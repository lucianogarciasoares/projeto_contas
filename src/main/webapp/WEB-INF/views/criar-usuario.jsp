					...
					<div class="card-body">
						...
						<form method="post" action="criar-usuario-post">
							...
							<div class="mb-3">
								...
								<form:input path="dto.nome" type="text" class="form-control"
									id="nome" name="nome" required="required"
									pattern="^[A-Za-zÀ-Üà-ü\s]{8,150}$"
									title="Informe um nome válido de 8 até 150 caracteres." />
							</div>

							<div class="mb-3">
								<label for="email" class="form-label"> Email de acesso:
								</label>
								<form:input path="dto.email" type="email" class="form-control"
									id="email" name="email" required="required" />
							</div>

							<div class="mb-3">
								<label for="senha" class="form-label"> Senha de acesso:
								</label>
								<form:input path="dto.senha" type="password"
